...
class PluginUpdateChecker_1_5 {
	...
	public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = ''){
		...
		// sebcus, prevent warning when not connected to the internet
		$this->debugMode = defined('WP_DEBUG') && WP_DEBUG && defined('TVR_DEV_MODE') && TVR_DEV_MODE;
        ...
        //=sebcus manually check for updates if user initiates
        if (isset($_POST['tvr_validate_one_off']['manual_update']) and $_POST['tvr_validate_one_off']['manual_update'] == 1) {
